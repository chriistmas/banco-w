...
<head>
    <meta charset="UTF-8">
    <title>Canales Presenciales - Banco W</title>
...
<div class="main-content">
    <section class="hero">
        <div class="hero-content">
            <div class="hero-text">
                <h1>Canales Presenciales</h1>
                <p>Conozca más sobre nuestra organización.</p>
            </div>
            <div class="hero-image">
                <img src="img/presenciales.png" class="hero-img" alt="Canales Presenciales">
            </div>
        </div>
    </section>
    
        <section class="documentacion-section">
            <h2>Sucursales y Oficinas</h2>
            <ul>
                <li>📍 Oficina Central: Lima, Av. Arequipa 1010</li>
                <li>📍 Sucursal Surco: Av. Caminos del Inca 123</li>
                <li>📍 Agencia San Juan: Jr. Los Olivos 456</li>
                <li>📍 Cajero Express: Mall del Sur</li>
            </ul>
        </section>
