...
<head>
    <meta charset="UTF-8">
    <title>Canales No Presenciales - Banco W</title>
...
<div class="main-content">
    <section class="hero">
        <div class="hero-content">
            <div class="hero-text">
                <h1>Canales No Presenciales</h1>
                <p>Conozca más sobre nuestra organización.</p>
            </div>
            <div class="hero-image">
                <img src="img/nopresenciales.png" class="hero-img" alt="Canales No Presenciales">
            </div>
        </div>
    </section>
    
        <section class="documentacion-section">
            <h2>Atención Virtual y Telefónica</h2>
            <ul>
                <li>📞 Línea gratuita: 0800-12345</li>
                <li>💻 Portal del Cliente: www.bancow.pe/clientes</li>
                <li>📱 App Banco W - disponible en iOS y Android</li>
