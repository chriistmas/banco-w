...
<head>
    <meta charset="UTF-8">
    <title>Gobierno Corporativo - Banco W</title>
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <div class="hero-image">
                <img src="img/gobierno.png" class="hero-img" alt="Gobierno Corporativo">
            </div>
        </div>
    </section>
    
        <section class="documentacion-section">
            <h2>Principios y Reglamentos</h2>
            <ul>
                <li>📘 Código de Buen Gobierno Corporativo</li>
                <li>🧭 Política de Transparencia y Ética</li>
                <li>📄 Manual de Procedimientos Internos</li>
                <li>⚖️ Comité de Auditoría y Cumplimiento</li>
            </ul>
        </section>
