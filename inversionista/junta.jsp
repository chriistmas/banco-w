...
<head>
    <meta charset="UTF-8">
    <title>Junta Directiva y Alta Gerencia - Banco W</title>
    <link rel="stylesheet" href="styles.css">
    <style>
        .documentacion-section, .accionistas-section {
            padding: 4rem 2rem;
            max-width: 1000px;
            margin: 0 auto;
        }
...
<div class="main-content">
    <section class="hero">
        <div class="hero-content">
            <div class="hero-text">
                <h1>Junta Directiva y Alta Gerencia</h1>
                <p>Conozca más sobre nuestra organización.</p>
            </div>
            <div class="hero-image">
                <img src="img/junta.png" class="hero-img" alt="Junta Directiva y Alta Gerencia">
            </div>
        </div>
    </section>
        ...
        <section class="accionistas-section">
            ...
            <div class="accionista-card"><h3>Dr. Juan Ramírez</h3><p><strong>Cargo:</strong> Presidente del Directorio</p></div>
            <div class="accionista-card"><h3>Lic. Teresa Gómez</h3><p><strong>Cargo:</strong> Vicepresidenta</p></div>
            <div class="accionista-card"><h3>Ing. Pablo Núñez</h3><p><strong>Cargo:</strong> Director Independiente</p></div>
            <h2>Alta Gerencia</h2>
            <div class="accionista-card"><h3>MSc. Carolina Vega</h3><p><strong>Cargo:</strong> Gerente General</p></div>
            <div class="accionista-card"><h3>Lic. Andrés Torres</h3><p><strong>Cargo:</strong> Gerente de Finanzas</p></div>
        </section>
