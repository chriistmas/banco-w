...
<head>
    <meta charset="UTF-8">
    <title>Información Relevante - Banco W</title>
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <div class="hero-image">
                <img src="img/relevante.png" class="hero-img" alt="Información Relevante">
            </div>
        </div>
    </section>
        ...
        <section class="documentacion-section">
            ...
            <ul>
                <li>📢 Reestructuración de la línea de crédito internacional - Junio 2025</li>
                <li>📈 Nueva política de inversión aprobada por la junta - Mayo 2025</li>
                <li>💼 Cambio de gerencia general - Abril 2025</li>
                <li>🔐 Actualización en normativas de seguridad financiera - Marzo 2025</li>
            </ul>
        </section>
