...
<head>
    <meta charset="UTF-8">
    <title>Documentación Societaria - Banco W</title>
...
<div class="main-content">
    <section class="hero">
        <div class="hero-content">
            <div class="hero-text">
                <h1>Documentación Societaria</h1>
                <p>Consulta los documentos legales y oficiales del Banco W.</p>
            </div>
            <div class="hero-image">
                <img src="img/documentacion.png" class="hero-img" alt="Documentación Societaria">
            </div>
        </div>
    </section>

    <section class="documentacion-section">
        <h2>Documentos Legales Vigentes</h2>
        <table class="doc-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td>Enero 2024</td>
                    <td><a href="#" class="doc-link">Ver PDF</a></td>
                </tr>
                <tr>
                    <td>Reglamento Interno de Gobierno</td>
                    <td>Marzo 2024</td>
                    <td><a href="#" class="doc-link">Ver PDF</a></td>
                </tr>
                <tr>
                    <td>Acta de Junta de Accionistas</td>
                    <td>Mayo 2024</td>
                    <td><a href="#" class="doc-link">Ver PDF</a></td>
                </tr>
                <tr>
